...
change the page-table root, as it is stored in *satp* together with other
virtual-memory parameters. More detail are described in
xref:supervisor-level-csrs-section[xrefstyle=short].

WARNING: #TODO: We don't mention *satp* in this section?#
